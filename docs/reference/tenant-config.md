...
fillers: ["Okay.", "Let me check.", "One moment."]   # phone only: spoken by the system the instant a turn is handed to the model, so the caller never waits in silence; never in a transcript
